...
@RequestMapping(path = BackofficeController.BUSINESS_USER_MANAGE_PATH)
public class BusinessUserManageController {
    ...
    @PostMapping(name = "사업자 회원 등록", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
