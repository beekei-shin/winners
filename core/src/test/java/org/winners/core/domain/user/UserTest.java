...
class UserTest {
    ...
    void isBlockUser() {
        ClientUser user = ClientUserMock.createUser(1L);
        assertThat(user.isBlockUser()).isEqualTo(false);

        ClientUser blockUser = ClientUserMock.createBlockUser(1L);
    ...
    void isResignUser() {
        ...
        ClientUser resignUser = ClientUserMock.createResignUser(1L);
