...
import com.winners.appApi.presentation.cert.v1.request.CertifyPhoneIdentityOtpNumberRequestDTO;
import com.winners.appApi.presentation.cert.v1.request.SendPhoneIdentityOtpNumberRequestDTO;
import com.winners.appApi.presentation.cert.v1.response.SendPhoneIdentityOtpNumberResponseDTO;
...
@RequestMapping(path = AppController.PHONE_IDENTITY_CERT_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
public class PhoneIdentityCertificationController {
    ...
    @PostMapping(name = "휴대폰 본인인증 OTP 번호 발송", path = "otp-number", consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(name = "휴대폰 본인인증 OTP 번호 인증", path = "/otp-number", consumes = MediaType.APPLICATION_JSON_VALUE)
